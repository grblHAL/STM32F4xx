...
#define Z_DIRECTION_BIT     (1<<Z_DIRECTION_PIN)
 ...
 #if X_GANGED || X_AUTO_SQUARE
  #define STEP_MASK           (X_STEP_BIT|X2_STEP_BIT|Y_STEP_BIT|Z_STEP_BIT|A_STEP_BIT) // All step bits
  #define DIRECTION_MASK      (X_DIRECTION_BIT|X2_DIRECTION_BIT|Y_DIRECTION_BIT|Z_DIRECTION_BIT|A_DIRECTION_BIT) // All direction bits
 #elif   Y_GANGED || Y_AUTO_SQUARE
  #define STEP_MASK           (X_STEP_BIT|Y_STEP_BIT|Y2_STEP_BIT|Z_STEP_BIT|A_STEP_BIT) // All step bits
  #define DIRECTION_MASK      (X_DIRECTION_BIT|Y_DIRECTION_BIT|Y2_DIRECTION_BIT|Z_DIRECTION_BIT|A_DIRECTION_BIT) // All direction bits
 #elif   Z_GANGED || Z_AUTO_SQUARE
  #define STEP_MASK           (X_STEP_BIT|Y_STEP_BIT|Z_STEP_BIT|Z2_STEP_BIT|A_STEP_BIT) // All step bits
  #define DIRECTION_MASK      (X_DIRECTION_BIT|Y_DIRECTION_BIT|Z_DIRECTION_BIT|Z2_DIRECTION_BIT|A_DIRECTION_BIT) // All direction bits
 #else
...
#else
 #if X_GANGED || X_AUTO_SQUARE
  #define STEP_MASK           (X_STEP_BIT|X2_STEP_BIT|Y_STEP_BIT|Z_STEP_BIT) // All step bits
  #define DIRECTION_MASK      (X_DIRECTION_BIT|X2_DIRECTION_BIT|Y_DIRECTION_BIT|Z_DIRECTION_BIT) // All direction bits
 #elif   Y_GANGED || Y_AUTO_SQUARE
  #define STEP_MASK           (X_STEP_BIT|Y_STEP_BIT|Y2_STEP_BIT|Z_STEP_BIT) // All step bits
  #define DIRECTION_MASK      (X_DIRECTION_BIT|Y_DIRECTION_BIT|Y2_DIRECTION_BIT|Z_DIRECTION_BIT) // All direction bits
 #elif   Z_GANGED || Z_AUTO_SQUARE
